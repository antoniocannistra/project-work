...
SELECT
   --pass.nome, pass.cognome, COALESCE(pass.cf, pass.p_iva) as "identificativo",
   s1.nome, s2.nome,to_char(b.data_emissione, 'DD/MM/YYYY HH24:MI') , p.prezzo, tb.descrizione
...
--Visualizza tutte le tratte effettuate da uno specifico treno in un intervallo di tempo (SISTEMARE)
SELECT
     s1.nome "Stazione di partenza",
     s2.nome "Stazione di arrivo",
     TO_CHAR(e.partenza_prevista,'DD/MM/YYYY HH24:MI') "Partenza prevista",
     TO_CHAR(e.partenza_effettiva,'DD/MM/YYYY HH24:MI') "Partenza effettiva"
FROM effettua e
    JOIN tratta t ON e.id_tratta = e.id_tratta
    JOIN treno tr ON tr.matricola = e.id_treno
    JOIN stazione s1 ON s1.id_stazione = t.id_stazione_partenza
    JOIN stazione s2 ON s2.id_stazione = t.id_stazione_arrivo
    JOIN cambio c1 ON c1.id_tratta = t.id_tratta
WHERE
    tr.matricola = '100291' AND
    e.partenza_prevista BETWEEN '2025-03-19 00:00:00.000000' AND '2025-04-19 00:00:00.000000'
    and c1.partenza_prevista BETWEEN '2025-03-19 00:00:00.000000' AND '2025-04-19 00:00:00.000000';
